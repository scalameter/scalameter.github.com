...
* [`MemoryFootprint`](http://scalameter.github.io/home/gettingstarted/executors/) measurer allows measuring the memory footprint of a data structure
* [`-CscopeFilter`](http://scalameter.github.io/home/gettingstarted/sbt/) option allows selectively running only specific tests from your suite
* time units now added to regression and logging reporters
* the [`include` statement](http://scalameter.github.io/home/gettingstarted/configuration/) for composing several test classes is now more powerful –- the enclosing class overrides the persistor and reporter values of the nested test classes, but those tests still use their own executors
